...
type ModelInterface interface {
	...
	List(opts v1.ListOptions) (*v1beta1.ModelList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Model, err error)
	ModelExpansion
}
...
func newModels(c *ConfigV1beta1Client, namespace string) *models {
	return &models{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *models) Get(name string, options v1.GetOptions) (result *v1beta1.Model, err error) {
...
func (c *models) List(opts v1.ListOptions) (result *v1beta1.ModelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ModelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) Create(model *v1beta1.Model) (result *v1beta1.Model, err error) {
	result = &v1beta1.Model{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) Update(model *v1beta1.Model) (result *v1beta1.Model, err error) {
	result = &v1beta1.Model{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Model, err error) {
	result = &v1beta1.Model{}
