...
// RegistryInterface has methods to work with ModelRegistry resources.
...
func newRegistries(c *ConfigV1beta1Client, namespace string) *registries {
	return &registries{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *registries) Get(name string, options v1.GetOptions) (result *v1beta1.ModelRegistry, err error) {
...
func (c *registries) List(opts v1.ListOptions) (result *v1beta1.ModelRegistryList, err error) {
...
func (c *registries) Create(registry *v1beta1.ModelRegistry) (result *v1beta1.ModelRegistry, err error) {
	result = &v1beta1.ModelRegistry{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("registries").
...
func (c *registries) Update(registry *v1beta1.ModelRegistry) (result *v1beta1.ModelRegistry, err error) {
	result = &v1beta1.ModelRegistry{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("registries").
...
func (c *registries) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.ModelRegistry, err error) {
	result = &v1beta1.ModelRegistry{}
