...
import (
	v1beta1 "github.com/onosproject/onos-operator/pkg/apis/clientset/versioned/typed/config/v1beta1"
...
func (c *FakeConfigV1beta1) Models(namespace string) v1beta1.ModelInterface {
